...
public class SimpleCorpusFactory implements CorpusFactory {
	...
	private static SimpleCorpusFactory instance = null;
	
	private SimpleCorpusFactory(){}
	
	/**
	 * Returns an instance of <tt>SimpleCorpusFactory</tt>. 
	 */
	public static SimpleCorpusFactory getInstance(){
		if(instance == null)instance = new SimpleCorpusFactory();
		return instance;		
	}
	...
	public Corpus createCorpus(String... args) {
		...
		while(line != null){
			...
			SimpleDoc doc = new SimpleDoc(strs[0], strs[1], ',');
			corpus.addDoc(doc);
			line = in.readLine();
		}
		in.close();
