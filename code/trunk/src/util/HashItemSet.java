 ...
 * allows to index a <tt>Item</tt> object though the <code>iid</code> using the
 * method <code>getItem(int iid)</code>.<p>
 * It is similar with <tt>HashSet</tt>, but it does not permit the null element and can index Item by iid.  
 * 
 * 
...
public class HashItemSet extends AbstractItemSet implements ItemSet, Set<Item>, Cloneable, java.io.Serializable{
    ...
    public boolean remove(Object o) {
    	if(o instanceof Item){
    		return map.remove(((Item) o).getUid()) == o;
    	}
        return false;
    }
