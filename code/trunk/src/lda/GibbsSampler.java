 ...
 * More about Gibbs sampling, see the paper:
...
//	private int numI;// iteration number
	...
	private double[] p;
	private int[][] cntZ;// topic assignments for words, size D*document.wordCount()
	...
	/**
	 * Constructs a GibbsSampling object based on the given parameters. 
	 */
	public GibbsSampler(Corpus corpus, int topicNum, double alpha, double beta){
		this.corpus = corpus;
	...
	/**
	 * Used by LDA for saving the cntDT matrix. 
	 */
	protected int[][] cntDT(){
		return cntDT;
	}
	...
	/**
	 * Used by LDA for saving the cntTW matrix. 
	 */
	protected int[][] cntTW(){
		return cntTW;
	}
