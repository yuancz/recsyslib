 ...
 * allows to index a <tt>User</tt> object though the <code>userId</code> using the
 * method <code>getUser(int userId)</code>.<p>
 * It is similar with <tt>HashSet</tt>, but it does not permit the null element and can index User by userId.  
 * 
 * 
...
public class HashUserSet extends AbstractUserSet implements UserSet, Set<User>, Cloneable, java.io.Serializable{
    ...
    public boolean add(User e) {
        ...
        return map.put(e.getUserId(), e)==null;
    }
    ...
    public boolean remove(Object o) {
    	if(o instanceof User){
    		return map.remove(((User) o).getUserId()) == o;
    	}
        return false;
    }
